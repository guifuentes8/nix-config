{}: ''
  ...
  exec-once = bash ~/dotfiles/users/guifuentes8/software-configs/swww/change-wallpaper.sh init 
  ...
  bind = $mainMod, W, exec, bash ~/dotfiles/users/guifuentes8/software-configs/swww/change-wallpaper.sh change
